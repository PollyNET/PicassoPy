...
def quasi_retrieval(height, att_beta, molExt, molBsc, LRaer, nIters=2):
    ...
    HISTORY:
        ...
        - 2025-03-21: AI based translation to python
    """
...
def quasi_pdr(data_cube, wvs=[532]):
    """
    """
    ...
    for wv in wvs:
        ...
        quasi_bsc = data_cube.data_retrievals[f"quasiBscV1_{wv}_{t}_{tel}"]
        ...
        data_cube.data_retrievals[f"quasiPdrV1_{wv}_{t}_{tel}"] = quasi_pdr
        data_cube.data_retrievals[f"quasiVdrV1_{wv}_{t}_{tel}"] = vdr


def quasi_angstrom(data_cube):
    """ """

    t = 'total'
    tel = 'FR'
    ratio_par_bsc = data_cube.data_retrievals[f'quasiBscV1_532_{t}_{tel}'] / \
        data_cube.data_retrievals[f'quasiBscV1_1064_{t}_{tel}']
    ratio_par_bsc[ratio_par_bsc < 0] = np.nan
    data_cube.data_retrievals[f"quasiAEV1_532_1064"] = ratio_par_bsc / np.log(532/1064)



def target_cat(data_cube):
    """ """
    ...
    tcMaskV1 = target_classify(data_cube.data_retrievals['range'],
        data_cube.data_retrievals['attBsc_532_total_FR'], data_cube.data_retrievals['quasiBscV1_1064_total_FR'],
        data_cube.data_retrievals['quasiBscV1_532_total_FR'], data_cube.data_retrievals['quasiPdrV1_532_total_FR'],
        data_cube.data_retrievals['quasiVdrV1_532_total_FR'], data_cube.data_retrievals['quasiAEV1_532_1064'],
    ...
    tcMaskV1[data_cube.data_retrievals['depCalMask'], :] = 0
    # add fog mask
    # add low SNR mask
    ...
    data_cube.data_retrievals[f"tcMaskV1"] = tcMaskV1
