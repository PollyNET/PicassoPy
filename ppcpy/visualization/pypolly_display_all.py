    ...
    if ('profiles' in args.retrieval):
        ...
        try:
            ...
            for profile in nc_profiles:
                ...
                starttime=datetime.utcfromtimestamp(int(nc_dict_profile['start_time']['data'])).strftime('%H:%M')
                endtime=datetime.utcfromtimestamp(int(nc_dict_profile['end_time']['data'])).strftime('%H:%M')
            ...
            for NR_profile in nc_profiles_NR:
                ...
                starttime=datetime.utcfromtimestamp(int(nc_dict_profile_NR['start_time']['data'])).strftime('%H:%M')
                endtime=datetime.utcfromtimestamp(int(nc_dict_profile_NR['end_time']['data'])).strftime('%H:%M')
            ...
            for OC_profile in nc_profiles_OC:
                ...
                starttime=datetime.utcfromtimestamp(int(nc_dict_profile_OC['start_time']['data'])).strftime('%H:%M')
                endtime=datetime.utcfromtimestamp(int(nc_dict_profile_OC['end_time']['data'])).strftime('%H:%M')
            ...
            for POLIPHON in nc_profiles_POLIPHON:
                ...
                starttime=datetime.utcfromtimestamp(int(nc_dict_profile_POLI['start_time']['data'])).strftime('%H:%M')
                endtime=datetime.utcfromtimestamp(int(nc_dict_profile_POLI['end_time']['data'])).strftime('%H:%M')
